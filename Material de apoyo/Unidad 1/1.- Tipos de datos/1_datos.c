...
// Dentro de la programación en C, encontramos varios tipos de datos, entre ellos los más usados son:
...
/*
    Cada una de estas variables tienen variaciónes con más o menos cantidad de información (peso en bytes).
    los cuales se encontrarán con más detalles en el readme.md
*/